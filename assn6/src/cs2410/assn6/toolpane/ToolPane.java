...
public class ToolPane extends HBox {
    ...
    //This ComboBox contains three Integer objects with values 1, 3, 5, 7, and 9
    private ComboBox<Integer> strokeSize = new ComboBox<>(FXCollections.observableArrayList(1, 3, 5, 7, 9));
